    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('dashboard/all-blog')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('dashboard/add-blog')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('dashboard/contact/show')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('dashboard/links/show')}}" class="nav-link">
